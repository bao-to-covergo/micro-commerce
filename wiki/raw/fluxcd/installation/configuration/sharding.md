---
source_url: https://fluxcd.io/flux/installation/configuration/sharding/
fetched: 2026-05-01
---
  ...
  4. [Horizontal scaling](<https://fluxcd.io/flux/installation/configuration/sharding/>)
...
At [bootstrap time](</flux/installation/configuration/bootstrap-customization/>), you can define the number of shards and spin up a Flux controller instance for each shard.
...
Note that `notification-controller` and `source-watcher` are excluded from the shard configuration, as these controllers do not support sharding.
...
When upgrading Flux, either by rerunning bootstrap with a newer version or by using the [Flux GitHub Actions](</flux/flux-gh-action/#automate-flux-updates>), the sharded controllers will be automatically upgraded along with the main ones.
...
Last modified 2026-04-19: [Exclude source-watcher from shard configuration (e20eb393)](<https://github.com/fluxcd/website/commit/e20eb3935e60751fa2316f5820f8adb8852dbf72>)
