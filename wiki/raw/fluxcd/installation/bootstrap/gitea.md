---
source_url: https://fluxcd.io/flux/installation/bootstrap/gitea/
fetched: 2026-05-01
---
  ...
  4. [Gitea](<https://fluxcd.io/flux/installation/bootstrap/gitea/>)
...
The [flux bootstrap gitea](</flux/cmd/flux_bootstrap_gitea/>) command deploys the Flux controllers on a Kubernetes cluster and configures the controllers to sync the cluster state from a Gitea repository. Besides installing the controllers, the bootstrap command pushes the Flux manifests to the Gitea repository and configures Flux to update itself from Gitea.
...
Forgejo is a fork of Gitea (see their [Comparison with Gitea](<https://forgejo.org/compare-to-gitea/>)). Given that Forgejo is mainly backward compatible with Gitea, you can use the same commands that you use for Gitea and it will work.
