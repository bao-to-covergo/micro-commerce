---
source_url: https://fluxcd.io/flux/components/helm/options/
fetched: 2026-05-01
---
  ...
  4. [Controller Options](<https://fluxcd.io/flux/components/helm/options/>)
...
To customise the controller options at install time, please see the [bootstrap customization guide](</flux/installation/configuration/bootstrap-customization/>).
...
`UseHelm3Defaults`| `false`| Restores Helm v3 defaults. When enabled, uses client-side apply for installation and Helm's legacy readiness logic instead of the Helm v4 defaults (server-side apply and kstatus-based health checking).  
  
Last modified 2025-12-09: [Add '--override-manager' option to helm options (5794720e)](<https://github.com/fluxcd/website/commit/5794720e36803bc479dda39f748028dc82d473d0>)
