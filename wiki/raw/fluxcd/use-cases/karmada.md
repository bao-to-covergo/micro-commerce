---
source_url: https://fluxcd.io/flux/use-cases/karmada/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Use Cases](<https://fluxcd.io/flux/use-cases/>)
  3. [Karmada + Flux](<https://fluxcd.io/flux/use-cases/karmada/>)



# Karmada + Flux

How to use Karmada and Flux for distribution and management of multi-cluster Flux Helm releases.
...
Steps described in this document have been tested on Karmada 1.0, 1.1 and 1.2. To start up Karmada, you can refer to [here](<https://github.com/karmada-io/karmada/blob/master/docs/installation/installation.md>). If you just want to try Karmada, we recommend building a development environment by `hack/local-up-karmada.sh`.
```
...
In Karmada control plane, you need to install Flux crds but do not need controllers to reconcile them. They are treated as resource templates, not specific resource instances. Based on work API [here](<https://github.com/kubernetes-sigs/work-api>), they will be encapsulated as a work object deliverd to member clusters and reconciled by Flux controllers in member clusters finally.
```
