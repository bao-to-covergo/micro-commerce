---
source_url: https://fluxcd.io/flux/use-cases/gh-actions-auto-pr/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Use Cases](<https://fluxcd.io/flux/use-cases/>)
  3. [GitHub Actions Auto PR](<https://fluxcd.io/flux/use-cases/gh-actions-auto-pr/>)
...
From [Image Update Guide](</flux/guides/image-update/>) we saw that Flux can set `.spec.git.push.branch` to [Push updates to a different branch](</flux/guides/image-update/#push-updates-to-a-different-branch>) than the one used for checkout.
...
Last modified 2025-06-04: [Fix GitHub Action syntax error and filter with if statement (00462440)](<https://github.com/fluxcd/website/commit/004624401552e3f5b9b8225e093b3d2e1c574ef2>)
