---
source_url: https://fluxcd.io/flux/monitoring/alerts/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Monitoring](<https://fluxcd.io/flux/monitoring/>)
  3. [Alerts](<https://fluxcd.io/flux/monitoring/alerts/>)
...
To follow this guide you'll need a Kubernetes cluster bootstrapped with Flux. Please see the [get started guide](</flux/get-started/>) or the [installation guide](</flux/installation/>).

The Flux controllers emit Kubernetes events whenever a resource status changes. You can use the [notification-controller](</flux/components/notification/>) to forward these events to Slack, Microsoft Teams, Discord and others. The notification controller is part of the default Flux installation.
...
Flux supports various providers such as Discord, PagerDuty, Teams, Telegram, Sentry and many others. For a complete list please see the [Provider `.spec.type` documentation](</flux/components/notification/providers/#type>).
...
The GitHub, GitLab, Gitea, Bitbucket, and Azure DevOps providers are slightly different to the other providers. Instead of a stateless stream of events, the Git notification providers will link the event with accompanying Git commit which triggered the event. The linking is done by updating the commit status of a specific commit.
...
For more details on how to integrate Flux with Grafana API please see the [Grafana provider documentation](</flux/components/notification/providers/#grafana>).

Last modified 2026-04-15: [Fix typo in alerts.md regarding bootstrap repository (13ffdec5)](<https://github.com/fluxcd/website/commit/13ffdec595508440fa09fc47546a946a0ff504ef>)
