---
source_url: https://fluxcd.io/flux/migration/faq-migration/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Migrate from Flux v1](<https://fluxcd.io/flux/migration/>)
  3. [FAQ](<https://fluxcd.io/flux/migration/faq-migration/>)
...
We went through the following steps for our community:
  ...
  2. Continued work on the [Flux v2 roadmap](</roadmap/>).
  ...
  5. We [finally archived](</blog/2022/10/september-2022-update/#flux-legacy-v1-retirement-plan>) Flux Legacy and Helm Operator.
