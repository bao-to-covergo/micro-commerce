---
source_url: https://fluxcd.io/flux/flux-gh-action/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux GitHub Action](<https://fluxcd.io/flux/flux-gh-action/>)
...
The Flux GitHub Action is compatible with the Linux, macOS and Windows [GitHub-hosted Runners](<https://docs.github.com/en/actions/using-github-hosted-runners>).

The Flux GitHub Action is compatible with [self-hosted GitHub Runners](<https://docs.github.com/en/actions/hosting-your-own-runners>) for the following architectures:
...
A complete e2e testing workflow is available here [flux2-kustomize-helm-example](<https://github.com/fluxcd/flux2-kustomize-helm-example/blob/main/.github/workflows/e2e.yaml>)

Last modified 2025-10-20: [Add cosign v3 to 2.8 roadmap (5ba64466)](<https://github.com/fluxcd/website/commit/5ba644665977f5e0035789ec1c4e0d11cac60f2c>)
