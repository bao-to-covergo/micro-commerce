---
source_url: https://fluxcd.io/flux/gitops-toolkit/packages/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Toolkit Dev Guides](<https://fluxcd.io/flux/gitops-toolkit/>)
  3. [Using the GitOps Toolkit APIs with Go](<https://fluxcd.io/flux/gitops-toolkit/packages/>)
...
[HelmChart](</flux/components/source/helmcharts/>)| v1  
[OCIRepository](</flux/components/source/ocirepositories/>)| v1  
[Bucket](</flux/components/source/buckets/>)| v1  
...
For an example on how to build a Kubernetes controller that interacts with the GitOps Toolkit APIs see [source-watcher](</flux/gitops-toolkit/source-watcher/>).

Last modified 2025-06-12: [Promote Bucket API to v1 (39da012e)](<https://github.com/fluxcd/website/commit/39da012e2e53dfc0fbda1b498706772daf9827a3>)
