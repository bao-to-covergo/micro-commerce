---
source_url: https://fluxcd.io/flux/cmd/flux_create_secret_proxy/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create secret proxy](<https://fluxcd.io/flux/cmd/flux_create_secret_proxy/>)
...
The create secret proxy command generates a Kubernetes secret with the proxy address and the basic authentication credentials.
```
flux create secret proxy [name] [flags]
```

### Examples
```
 # Create a proxy secret on disk and encrypt it with SOPS
