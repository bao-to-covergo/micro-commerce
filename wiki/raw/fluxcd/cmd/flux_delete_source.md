---
source_url: https://fluxcd.io/flux/cmd/flux_delete_source/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux delete source](<https://fluxcd.io/flux/cmd/flux_delete_source/>)
...
### SEE ALSO
  ...
  * [flux delete source chart](<../flux_delete_source_chart/>) \- Delete a HelmChart source
  ...
  * [flux delete source oci](<../flux_delete_source_oci/>) \- Delete an OCIRepository source
