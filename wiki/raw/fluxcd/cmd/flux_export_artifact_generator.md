---
source_url: https://fluxcd.io/flux/cmd/flux_export_artifact_generator/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export artifact generator](<https://fluxcd.io/flux/cmd/flux_export_artifact_generator/>)
...
Export ArtifactGenerator resources in YAML format

### Synopsis

The export artifact generator command exports one or all ArtifactGenerator resources in YAML format.
```
flux export artifact generator [name] [flags]
```

### Examples
```
  # Export all ArtifactGenerator resources
...
### SEE ALSO
  ...
  * [flux export artifact](<../flux_export_artifact/>) \- Export artifact objects
