---
source_url: https://fluxcd.io/flux/cmd/flux_create_secret_tls/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create secret tls](<https://fluxcd.io/flux/cmd/flux_create_secret_tls/>)
...
### Examples
```
 # Create a TLS secret on disk and encrypt it with SOPS.
