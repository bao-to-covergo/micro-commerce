---
source_url: https://fluxcd.io/flux/cmd/flux_create_secret_oci/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create secret oci](<https://fluxcd.io/flux/cmd/flux_create_secret_oci/>)
...
Create or update a Kubernetes image pull secret
...
```
flux create secret oci [name] [flags]
```

### Examples
```
  # Create an OCI authentication secret on disk and encrypt it with Mozilla SOPS
