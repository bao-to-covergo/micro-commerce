---
source_url: https://fluxcd.io/flux/cmd/flux_suspend_alert-provider/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux suspend alert-provider](<https://fluxcd.io/flux/cmd/flux_suspend_alert-provider/>)
...
Suspend reconciliation of Provider

### Synopsis

The suspend command disables the reconciliation of a Provider resource.
```
flux suspend alert-provider [name] [flags]
```

### Examples
```
  # Suspend reconciliation for an existing Provider
