---
source_url: https://fluxcd.io/flux/cmd/flux_stats/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux stats](<https://fluxcd.io/flux/cmd/flux_stats/>)
...
Stats of Flux reconciles

### Synopsis

The stats command prints a report of Flux custom resources present on a cluster, including their reconcile status and the amount of cumulative storage used for each source type
...
### Examples
```
  # Print the stats report for a namespace
...
### Options
```
  -A, --all-namespaces   list the statistics for objects across all namespaces
