---
source_url: https://fluxcd.io/flux/cmd/flux_tree/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux tree](<https://fluxcd.io/flux/cmd/flux_tree/>)
...
Print the resources reconciled by Flux
...
### SEE ALSO
  ...
  * [flux tree kustomization](<../flux_tree_kustomization/>) \- Print the resource inventory of a Kustomization
