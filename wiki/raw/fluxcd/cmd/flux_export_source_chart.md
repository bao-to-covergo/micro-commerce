---
source_url: https://fluxcd.io/flux/cmd/flux_export_source_chart/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export source chart](<https://fluxcd.io/flux/cmd/flux_export_source_chart/>)
...
Export HelmChart sources in YAML format
...
```
flux export source chart [name] [flags]
```

### Examples
```
  # Export all chart sources
