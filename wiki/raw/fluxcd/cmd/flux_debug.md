---
source_url: https://fluxcd.io/flux/cmd/flux_debug/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux debug](<https://fluxcd.io/flux/cmd/flux_debug/>)
...
### SEE ALSO
  ...
  * [flux debug helmrelease](<../flux_debug_helmrelease/>) \- Debug a HelmRelease resource
  * [flux debug kustomization](<../flux_debug_kustomization/>) \- Debug a Flux Kustomization resource
