---
source_url: https://fluxcd.io/flux/cmd/flux_suspend/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux suspend](<https://fluxcd.io/flux/cmd/flux_suspend/>)
...
### SEE ALSO
  ...
  * [flux suspend alert-provider](<../flux_suspend_alert-provider/>) \- Suspend reconciliation of Provider
