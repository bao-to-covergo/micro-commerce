---
source_url: https://fluxcd.io/flux/cmd/flux_resume_alert/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux resume alert](<https://fluxcd.io/flux/cmd/flux_resume_alert/>)
...
The resume command marks a previously suspended Alert resource for reconciliation and waits for it to finish the apply.
```
