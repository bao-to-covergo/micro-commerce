---
source_url: https://fluxcd.io/flux/cmd/flux_get_artifacts/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux get artifacts](<https://fluxcd.io/flux/cmd/flux_get_artifacts/>)
...
### SEE ALSO
  ...
  * [flux get artifacts generators](<../flux_get_artifacts_generators/>) \- Get artifact generator statuses
