---
source_url: https://fluxcd.io/flux/cmd/flux_reconcile_source/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux reconcile source](<https://fluxcd.io/flux/cmd/flux_reconcile_source/>)
...
### SEE ALSO
  ...
  * [flux reconcile source chart](<../flux_reconcile_source_chart/>) \- Reconcile a HelmChart source
  ...
  * [flux reconcile source oci](<../flux_reconcile_source_oci/>) \- Reconcile an OCIRepository
