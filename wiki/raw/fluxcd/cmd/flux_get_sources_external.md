---
source_url: https://fluxcd.io/flux/cmd/flux_get_sources_external/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux get sources external](<https://fluxcd.io/flux/cmd/flux_get_sources_external/>)
...
Get ExternalArtifact source statuses

### Synopsis

The get sources external command prints the status of the ExternalArtifact sources.
```
flux get sources external [flags]
```

### Examples
```
  # List all ExternalArtifacts and their status
  flux get sources external
