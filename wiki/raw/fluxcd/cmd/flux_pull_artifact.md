---
source_url: https://fluxcd.io/flux/cmd/flux_pull_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux pull artifact](<https://fluxcd.io/flux/cmd/flux_pull_artifact/>)
...
```
  ...
  -h, --help                             help for artifact
      --insecure-registry                allows artifacts to be pulled without TLS
