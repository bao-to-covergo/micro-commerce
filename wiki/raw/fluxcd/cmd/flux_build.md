---
source_url: https://fluxcd.io/flux/cmd/flux_build/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux build](<https://fluxcd.io/flux/cmd/flux_build/>)
...
### SEE ALSO
  ...
  * [flux build artifact](<../flux_build_artifact/>) \- Build artifact
  * [flux build kustomization](<../flux_build_kustomization/>) \- Build Kustomization
