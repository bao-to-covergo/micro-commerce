---
source_url: https://fluxcd.io/flux/cmd/flux_reconcile_helmrelease/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux reconcile helmrelease](<https://fluxcd.io/flux/cmd/flux_reconcile_helmrelease/>)
...
### Options
```
      --force         force a one-off install or upgrade of the HelmRelease resource
  -h, --help          help for helmrelease
      --reset         reset the failure count for this HelmRelease resource
