---
source_url: https://fluxcd.io/flux/cmd/flux_create_secret/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create secret](<https://fluxcd.io/flux/cmd/flux_create_secret/>)
...
### SEE ALSO
  ...
  * [flux create secret githubapp](<../flux_create_secret_githubapp/>) \- Create or update a github app secret
  * [flux create secret helm](<../flux_create_secret_helm/>) \- Create or update a Kubernetes secret for Helm repository authentication
  * [flux create secret notation](<../flux_create_secret_notation/>) \- Create or update a Kubernetes secret for verifications of artifacts signed by Notation
  * [flux create secret oci](<../flux_create_secret_oci/>) \- Create or update a Kubernetes image pull secret
  * [flux create secret proxy](<../flux_create_secret_proxy/>) \- Create or update a Kubernetes secret for proxy authentication
  * [flux create secret receiver](<../flux_create_secret_receiver/>) \- Create or update a Kubernetes secret for a Receiver webhook
