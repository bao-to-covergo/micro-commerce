---
source_url: https://fluxcd.io/flux/cmd/flux_tree_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux tree artifact](<https://fluxcd.io/flux/cmd/flux_tree_artifact/>)
...
Print artifact objects reconciled by Flux
...
### SEE ALSO
  ...
  * [flux tree artifact generator](<../flux_tree_artifact_generator/>) \- Print the inventory of an ArtifactGenerator
