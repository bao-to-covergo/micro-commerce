---
source_url: https://fluxcd.io/flux/cmd/flux_export_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export artifact](<https://fluxcd.io/flux/cmd/flux_export_artifact/>)



# flux export artifact

## flux export artifact

Export artifact objects
...
### SEE ALSO
  ...
  * [flux export artifact generator](<../flux_export_artifact_generator/>) \- Export ArtifactGenerator resources in YAML format
