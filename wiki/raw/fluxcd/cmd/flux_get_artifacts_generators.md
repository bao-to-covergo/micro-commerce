---
source_url: https://fluxcd.io/flux/cmd/flux_get_artifacts_generators/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux get artifacts generators](<https://fluxcd.io/flux/cmd/flux_get_artifacts_generators/>)



# flux get artifacts generators

## flux get artifacts generators

Get artifact generator statuses

### Synopsis

The get artifact generator command prints the statuses of the resources.
```
flux get artifacts generators [flags]
```
...
### SEE ALSO
  ...
  * [flux get artifacts](<../flux_get_artifacts/>) \- Get artifact object status
