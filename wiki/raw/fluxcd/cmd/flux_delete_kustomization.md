---
source_url: https://fluxcd.io/flux/cmd/flux_delete_kustomization/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux delete kustomization](<https://fluxcd.io/flux/cmd/flux_delete_kustomization/>)
...
### Examples
```
  # Delete a kustomization and the Kubernetes resources created by it when prune is enabled
