---
source_url: https://fluxcd.io/flux/cmd/flux_export_source_external/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export source external](<https://fluxcd.io/flux/cmd/flux_export_source_external/>)
...
Export ExternalArtifact sources in YAML format

### Synopsis

The export source external command exports one or all ExternalArtifact sources in YAML format.
```
flux export source external [name] [flags]
```

### Examples
```
  # Export all ExternalArtifact sources
