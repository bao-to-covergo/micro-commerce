---
source_url: https://fluxcd.io/flux/cmd/flux_suspend_image/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux suspend image](<https://fluxcd.io/flux/cmd/flux_suspend_image/>)
...
### SEE ALSO
  ...
  * [flux suspend image policy](<../flux_suspend_image_policy/>) \- Suspend an ImagePolicy
