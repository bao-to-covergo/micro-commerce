---
source_url: https://fluxcd.io/flux/cmd/flux_build_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux build artifact](<https://fluxcd.io/flux/cmd/flux_build_artifact/>)
...
The build artifact command creates a tgz file with the manifests from the given directory or a single manifest file.
```
flux build artifact [flags]
```

### Examples
```
  # Build the given manifests directory into an artifact
