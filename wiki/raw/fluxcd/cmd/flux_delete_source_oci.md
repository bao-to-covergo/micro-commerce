---
source_url: https://fluxcd.io/flux/cmd/flux_delete_source_oci/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux delete source oci](<https://fluxcd.io/flux/cmd/flux_delete_source_oci/>)
...
Delete an OCIRepository source
...
```
flux delete source oci [name] [flags]
```
