---
source_url: https://fluxcd.io/flux/cmd/flux_create_source/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create source](<https://fluxcd.io/flux/cmd/flux_create_source/>)
...
### SEE ALSO
  ...
  * [flux create source chart](<../flux_create_source_chart/>) \- Create or update a HelmChart source
  ...
  * [flux create source oci](<../flux_create_source_oci/>) \- Create or update an OCIRepository
