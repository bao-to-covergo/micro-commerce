---
source_url: https://fluxcd.io/flux/cmd/flux_diff_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux diff artifact](<https://fluxcd.io/flux/cmd/flux_diff_artifact/>)
...
```
  ...
  -h, --help                             help for artifact
      ...
      --insecure-registry                allows the remote artifact to be pulled without TLS
