---
source_url: https://fluxcd.io/flux/cmd/flux_reconcile_source_chart/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux reconcile source chart](<https://fluxcd.io/flux/cmd/flux_reconcile_source_chart/>)
...
```
  -h, --help          help for chart
      --with-source   reconcile HelmChart source
```
