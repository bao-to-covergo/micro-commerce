---
source_url: https://fluxcd.io/flux/cmd/flux_export_source_oci/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export source oci](<https://fluxcd.io/flux/cmd/flux_export_source_oci/>)
...
Export OCIRepository sources in YAML format
...
```
flux export source oci [name] [flags]
```
