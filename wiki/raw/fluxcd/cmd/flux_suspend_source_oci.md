---
source_url: https://fluxcd.io/flux/cmd/flux_suspend_source_oci/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux suspend source oci](<https://fluxcd.io/flux/cmd/flux_suspend_source_oci/>)
...
Suspend reconciliation of an OCIRepository

### Synopsis

The suspend command disables the reconciliation of an OCIRepository resource.
```
flux suspend source oci [name] [flags]
```

### Examples
```
  # Suspend reconciliation for an existing OCIRepository
