---
source_url: https://fluxcd.io/flux/cmd/flux_create_image/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux create image](<https://fluxcd.io/flux/cmd/flux_create_image/>)
...
The create image sub-commands work with image automation objects; that is, object controlling updates to git based on e.g., new container images being available.
