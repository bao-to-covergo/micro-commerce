---
source_url: https://fluxcd.io/flux/cmd/flux_resume_source_oci/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux resume source oci](<https://fluxcd.io/flux/cmd/flux_resume_source_oci/>)
...
Resume a suspended OCIRepository

### Synopsis

The resume command marks a previously suspended OCIRepository resource for reconciliation and waits for it to finish.
```
flux resume source oci [name] [flags]
```

### Examples
```
  # Resume reconciliation for an existing OCIRepository
