---
source_url: https://fluxcd.io/flux/cmd/flux_reconcile_image/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux reconcile image](<https://fluxcd.io/flux/cmd/flux_reconcile_image/>)
...
### SEE ALSO
  ...
  * [flux reconcile image policy](<../flux_reconcile_image_policy/>) \- Reconcile an ImagePolicy
