---
source_url: https://fluxcd.io/flux/cmd/flux_resume_helmrelease/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux resume helmrelease](<https://fluxcd.io/flux/cmd/flux_resume_helmrelease/>)
...
The resume command marks a previously suspended HelmRelease resource for reconciliation and waits for it to finish the apply.
```
