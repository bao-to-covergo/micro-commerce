---
source_url: https://fluxcd.io/flux/cmd/flux_completion_powershell/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux completion powershell](<https://fluxcd.io/flux/cmd/flux_completion_powershell/>)
...
The completion sub-command generates completion scripts for powershell.
```
