---
source_url: https://fluxcd.io/flux/cmd/flux_debug_kustomization/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux debug kustomization](<https://fluxcd.io/flux/cmd/flux_debug_kustomization/>)
...
Debug a Flux Kustomization resource

### Synopsis

The debug kustomization command can be used to troubleshoot failing Flux Kustomization reconciliations. WARNING: This command will print sensitive information if Kubernetes Secrets are referenced in the Kustomization .spec.postBuild.substituteFrom field.
...
```
flux debug kustomization [name] [flags]
```

### Examples
```
  # Print the status of a Flux Kustomization
