---
source_url: https://fluxcd.io/flux/cmd/flux_export_source/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux export source](<https://fluxcd.io/flux/cmd/flux_export_source/>)
...
### SEE ALSO
  ...
  * [flux export source chart](<../flux_export_source_chart/>) \- Export HelmChart sources in YAML format
  * [flux export source external](<../flux_export_source_external/>) \- Export ExternalArtifact sources in YAML format
  ...
  * [flux export source oci](<../flux_export_source_oci/>) \- Export OCIRepository sources in YAML format
