---
source_url: https://fluxcd.io/flux/cmd/flux_tag_artifact/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux tag artifact](<https://fluxcd.io/flux/cmd/flux_tag_artifact/>)
...
The tag artifact command creates tags for the given OCI artifact. The command can read the credentials from '~/.docker/config.json' but they can also be passed with -creds. It can also login to a supported provider with the -provider flag.
```
flux tag artifact [flags]
```

### Examples
```
  # Tag an artifact version as latest
