---
source_url: https://fluxcd.io/flux/cmd/flux_envsubst/
fetched: 2026-05-01
---

  1. [Docs](<https://fluxcd.io/flux/>)
  2. [Flux CLI](<https://fluxcd.io/flux/cmd/>)
  3. [flux envsubst](<https://fluxcd.io/flux/cmd/flux_envsubst/>)
...
The envsubst command substitutes the values of environment variables in the string piped as standard input and writes the result to the standard output. This command can be used to replicate the behavior of the Flux Kustomization post-build substitutions.
...
### Examples
```
  # Run env var substitutions on the kustomization build output
...
```
  -h, --help     help for envsubst
      --strict   fail if a variable without a default value is declared in the input but is missing from the environment
```
